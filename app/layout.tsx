...
export const metadata: Metadata = {
  ...
  description: "Techletics '25 - The largest technical festival of Kerala at Christ College of Engineering, Irinjalakuda. Join us for hackathons, coding competitions, robotics events, and technical workshops.",
  keywords: [
    "Techletics",
    "Tech Fest",
  ...
  category: "Technology",
  robots: process.env.NODE_ENV === 'development' 
  ...
  openGraph: {
    ...
    description: "Join Kerala's largest technical festival at Christ College of Engineering. Experience hackathons, coding competitions, robotics events, and technical workshops.",
    type: "website",
    locale: "en_US",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className={`${turretRoad.variable} ${Fonarto.variable} antialiased`}>
        {children}
      </body>
    </html>
  );
