...
export default function Banner() {
  return (
    <section className="relative mx-auto flex max-w-screen-2xl items-center justify-center overflow-clip px-12 py-5">
      <div className="flex w-[1024px] items-center justify-center p-2 pt-[1rem] font-orbitron text-4xl font-extrabold tracking-wide text-secondary sm:justify-between md:pt-[6rem] md:text-7xl">
