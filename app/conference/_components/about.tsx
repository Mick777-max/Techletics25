...
export default function Conferenceabout() {
  return (
    <main className="relative mx-auto flex h-auto max-w-screen-xl flex-col items-start overflow-hidden pb-20 max-md:items-center">
      ...
      <div className="mt-[4rem] flex w-full items-center justify-between gap-6 max-md:flex-col">
        <div className="max-md:mx-3">
          <p className="font-opensans text-xl font-extralight text-quarternary">
            Join us for the{' '}
