  ...
  return title === 'Executive' ? (
    ...
    >
      ...
      <div className="mt-8 flex justify-center">
        <div
          className="h-[9rem] w-[9rem] overflow-hidden rounded-full border-[0.1875rem] border-[#79662f] bg-quarternary shadow-[0_0_20px_4px_rgba(199,154,66,0.6)] transition-all duration-300"
          // style={{
          //   clipPath: "inset(4px)",
          // }}
        >
