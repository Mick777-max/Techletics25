...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 z-[60] w-full border-b border-white/20 bg-[linear-gradient(to_bottom,_#323232_0%,_#353535_10%,_#40403F_50%,_#494948_85%,_#4D4D4C_100%)] shadow-lg backdrop-blur-lg">
